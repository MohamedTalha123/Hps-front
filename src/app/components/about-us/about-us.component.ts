...
export class AboutUsComponent {
  ...
  brands = [
      ...
      { 
        name: 'CASIO', 
        logo: '../../../assets/images/about-us/casio.png',
      ...
      { 
        name: 'OMEGA', 
        logo: '../../../assets/images/about-us/omega.png',
      ...
      { 
        name: 'ROLEX', 
        logo: '../../../assets/images/about-us/rolex.png',
      ...
      { 
        name: 'FESTINA', 
        logo: '../../../assets/images/about-us/festina.png',
      ...
      { 
        name: 'DANIEL HECHTER', 
        logo: '../../../assets/images/about-us/daniel-hechter.png',
      ...
      { 
        name: 'YONGER & BRESSON', 
        logo: '../../../assets/images/about-us/yonger-bresson.png',
      ...
      { 
        name: 'MORGAN', 
        logo: '../../../assets/images/about-us/morgan.png',
      ...
      { 
        name: 'PACO RABANNE', 
        logo: '../../../assets/images/about-us/paco-rabanne.png',
      ...
      { 
        name: 'YEMA', 
        logo: '../../../assets/images/about-us/yema.png',
      ...
      { 
        name: 'RHYTHM', 
        logo: '../../../assets/images/about-us/rhythm.png',
